...
public class PacienteServiceImpl implements PacienteService {
    ...
    @Override
    @Transactional(readOnly = true)
    public Optional<PacienteDTO> findOneByKeycloakId(String keycloakId) {
        LOG.debug("Request to get Paciente by keycloakId : {}", keycloakId);
        return pacienteRepository.findOneByKeycloakId(keycloakId).map(pacienteMapper::toDto);
    }
