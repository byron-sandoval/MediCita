...
import com.medicita.app.repository.PagoRepository;
import com.medicita.app.service.dto.PagoDTO;
import com.medicita.app.service.mapper.PagoMapper;
...
class PagoResourceIT {
    ...
    private static final MetodoPago DEFAULT_METODO = MetodoPago.TARJETA;
    private static final MetodoPago UPDATED_METODO = MetodoPago.EFECTIVO;
    ...
    private static final String DEFAULT_TRANSACCION_ID = "AAAAAAAAAA";
    private static final String UPDATED_TRANSACCION_ID = "BBBBBBBBBB";
    ...
    public static Pago createEntity() {
        return new Pago()
            ...
            .transaccionId(DEFAULT_TRANSACCION_ID)
    ...
    public static Pago createUpdatedEntity() {
        return new Pago()
            ...
            .transaccionId(UPDATED_TRANSACCION_ID)
    ...
    void getAllPagos() throws Exception {
        ...
        restPagoMockMvc
            ...
            .andExpect(jsonPath("$.[*].transaccionId").value(hasItem(DEFAULT_TRANSACCION_ID)))
    ...
    void getPago() throws Exception {
        ...
        restPagoMockMvc
            ...
            .andExpect(jsonPath("$.transaccionId").value(DEFAULT_TRANSACCION_ID))
