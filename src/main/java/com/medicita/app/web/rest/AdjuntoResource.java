...
public class AdjuntoResource {
    ...
    public ResponseEntity<AdjuntoDTO> createAdjunto(@Valid @RequestBody AdjuntoDTO adjuntoDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/adjuntos/" + adjuntoDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, adjuntoDTO.getId().toString()))
            .body(adjuntoDTO);
    }
    ...
    public ResponseEntity<AdjuntoDTO> updateAdjunto(
        ...
        @Valid @RequestBody AdjuntoDTO adjuntoDTO
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, adjuntoDTO.getId().toString()))
            .body(adjuntoDTO);
    }
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated adjuntoDTO,
     * or with status {@code 400 (Bad Request)} if the adjuntoDTO is not valid,
     * or with status {@code 404 (Not Found)} if the adjuntoDTO is not found,
     * or with status {@code 500 (Internal Server Error)} if the adjuntoDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    public ResponseEntity<AdjuntoDTO> partialUpdateAdjunto(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody AdjuntoDTO adjuntoDTO
    ) throws URISyntaxException {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<AdjuntoDTO>> getAllAdjuntos(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
