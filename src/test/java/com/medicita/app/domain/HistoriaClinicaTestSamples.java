...
public class HistoriaClinicaTestSamples {
    ...
    public static HistoriaClinica getHistoriaClinicaSample1() {
        return new HistoriaClinica().id(1L).diagnostico("diagnostico1").tratamiento("tratamiento1");
    }

    public static HistoriaClinica getHistoriaClinicaSample2() {
        return new HistoriaClinica().id(2L).diagnostico("diagnostico2").tratamiento("tratamiento2");
    }
